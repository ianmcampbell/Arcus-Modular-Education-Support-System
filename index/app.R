...
ui <- fluidPage(
    ...
    tags$br(),tags$br(),
    a("Example R Beginner Lesson Plan",href="http://www.a-mess.org/Personalized-Learning-Plan/?&modules=sHXtfjmhu84EQfHM7VpLV&curricula=qiJ&modulesplit=MTMsMA~~"),
    ...
    tags$br(),tags$br(),
    a("Example Statistics Lesson Plan",href="http://www.a-mess.org/Personalized-Learning-Plan/?&modules=yoyXvAlV&curricula=qyR&modulesplit=NSww"),
    tags$h3("Example Lessons"),
    "Here are some additional example lessons",
    tags$br(),tags$br(),
    a("Basic Building Blocks",href="http://www.a-mess.org/swirl-basic-building-blocks/"),tags$br(),tags$br(),
    a("Variables",href="http://www.a-mess.org/sb-variables/"),tags$br(),tags$br(),
    a("Correlation and Linear Regression",href="http://www.a-mess.org/sb-correlation-and-linear-regression/"),
    ...
    tags$br(),tags$br(),
    a("Example Exercise in Python using pandas",href="http://www.a-mess.org/ic-python-demo/"),
    tags$br(),tags$br(),
    ...
    tags$br(),tags$br(),
    a("Custom Curriculum Generator",href="http://www.a-mess.org/Lesson-Generator/"),
